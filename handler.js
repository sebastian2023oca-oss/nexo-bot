...
async function cobrarImpuestoSilencioso(
userJid
){
...
{
text:
`⚠️ *Este bot solo funciona en grupos.*
...
*.addbot https://chat.whatsapp.com/xxxx*`
},
{
quoted:
mensaje
...
await cobrarImpuestoSilencioso(
userJid
)
